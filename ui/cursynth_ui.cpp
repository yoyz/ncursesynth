...
void CursynthUI::initControls() {
    ...
    widgets.emplace_back("AENV DECAY", 1, 5, 40, WidgetType::CONTINUOUS, 0.3f);
    widgets.emplace_back("AENV SUSTAIN", 2, 6, 40, WidgetType::CONTINUOUS, 0.7f);
    widgets.emplace_back("AENV RELEASE", 3, 7, 40, WidgetType::CONTINUOUS, 0.3f);
    ...
    widgets.emplace_back("VOLUME", 35, 4, 78, WidgetType::CONTINUOUS, 0.7f);
}
