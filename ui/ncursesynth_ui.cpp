...
void NcursesynthUI::initControls() {
    ...
    widgets.emplace_back("OSC1 WAVE", ParamID::osc1_wave, 0, 2, WidgetType::DISCRETE, 0.5f, 3);
    ...
    widgets.emplace_back("OSC2 WAVE", ParamID::osc2_wave, 5, 2, WidgetType::DISCRETE, 0.5f, 3);
    ...
    widgets.emplace_back("OSC2 AMP", ParamID::osc2_amp, 8, 2, WidgetType::CONTINUOUS, 1.0f);
    ...
    widgets.emplace_back("AENV DECAY", ParamID::amp_decay, 9, 40, WidgetType::CONTINUOUS, 0.3f);
    widgets.emplace_back("AENV SUSTAIN", ParamID::amp_sustain, 10, 40, WidgetType::CONTINUOUS, 0.7f);
    widgets.emplace_back("AENV RELEASE", ParamID::amp_release, 11, 40, WidgetType::CONTINUOUS, 0.3f);

    widgets.emplace_back("VOLUME", ParamID::volume, 4, 78, WidgetType::CONTINUOUS, 0.7f);
}
