...
void TwytchUI::initControls() {
    ...
    widgets.emplace_back("OSC1 WAVE", 20, 0, 2, WidgetType::DISCRETE, 0.0f, 12);
    ...
    widgets.emplace_back("OSC2 WAVE", 21, 7, 2, WidgetType::DISCRETE, 0.0f, 12);
    ...
    widgets.emplace_back("MASTER", 35, 15, 78, WidgetType::CONTINUOUS, 0.7f);
}
