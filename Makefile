...
test/ui_test.o: test/ui_test.cpp
	$(CXX) $(TEST_UI_CXXFLAGS) $(DEPFLAGS) -c $< -o $@
...
# =============================================================================
DEPS = $(OBJECTS:.o=.d) \
       test/test_runner.d test/test_reporter.d test/test_helpers.d \
       test/test_engine.d test/fake_audio_driver.d test/midi_simulator.d \
       test/ui_test.d
