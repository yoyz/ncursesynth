...
#pragma once
#ifndef TWITCHHELM_HELM_MODULE_H
#define TWITCHHELM_HELM_MODULE_H

#include "twytchhelm_mopo.h"
#include "twytchhelm_helm_common.h"
...
namespace twytchhelmmopo {
  ...
  class HelmModule : public virtual ProcessorRouter {
    public:
      ...
      // Returns a pointer to a specific control by name, or nullptr if not found.
      Value* getControl(std::string name);
